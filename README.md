...
File "minimum" contains your minimum code from "https://github.com/otree-tools/jbef-channels". I added a money IntegerField (initial=1000) in the Player class. For testing purposes I extended your code, so everytime an answer is submitted, 100 is subtracted from that value. Until here everything worked fine. 
...
I will upload a file with a simplified version of my crowdfuning project using Django tomorrow. Today I had a job interview, so I couldn´t have a look into it. The last days I was busy trying to understand the bug in the "min" file.
